...
from practice.app1.QuestionTwo import *
...
class Test(unittest.TestCase):
    ...
    def test_SpecialCases(self):
        ...
        # Emtpy folder
        answer = AnswerTwo(u'Q2Test1/2nd_level')
        self.assertEqual(answer.getFileList(), [])
        
        # Empty file and file with space
        answer = AnswerTwo(u'Q2Test1')
        self.assertEqual(answer.getFileList(), [])
        
        # The input is a file
        answer = AnswerTwo(u'Q2Test2/2nd_level/A_file.rtf')
        self.assertEqual(answer.getFileList(), [])
